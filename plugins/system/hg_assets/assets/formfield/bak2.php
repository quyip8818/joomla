...
<div class="wrap" id="manager_wrap">
	...
	.($dragging != 'no' ? '<span class="drag-dynoitem hg_uikit_button" title="click and drag to rearrange">Drag to arrange</span>':'').
	'<span class="remove-dynoitem hg_uikit_button" title="Remove '.$itemName.'">Remove '.$itemName.'</span>
	<span class="resize-dynoitem hg_uikit_button " title="Minimize Box">'.(($itemMinimized == 'yes' && $type =='default') ? 'Maximize Box' : 'Minimize Box').'</span>
