				...
				<fieldset class="haspad form-horizontal">
					...
					<table class="admintable">
						<tr>
							<td>
								<div class="control-group">
									<label for="vendor_store_name" class="control-label"><?php echo vmText::_('COM_VIRTUEMART_STORE_FORM_STORE_NAME'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label for="vendor_name" class="control-label"><?php echo vmText::_('COM_VIRTUEMART_STORE_FORM_COMPANY_NAME'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label for="vendor_url" class="control-label"><?php echo vmText::_('COM_VIRTUEMART_PRODUCT_FORM_URL'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label for="vendor_min_pov" class="control-label"><?php echo vmText::_('COM_VIRTUEMART_STORE_FORM_MPOV'); ?>:</label>
									<div class="controls">
				...
				<fieldset class="haspad form-horizontal">
					...
					<table class="admintable">
						<tr>
							<td>
								<div class="control-group">
									<label for="vendor_currency" class="control-label"><?php echo vmText::_('COM_VIRTUEMART_CURRENCY'); ?>:</label>
									<div class="controls">
						...
						<tr>
							<td>
								<div class="control-group">
									<label for="vendor_accepted_currencies" class="control-label"><?php echo vmText::_('COM_VIRTUEMART_STORE_FORM_ACCEPTED_CURRENCIES'); ?>:</label>
									<div class="controls">
