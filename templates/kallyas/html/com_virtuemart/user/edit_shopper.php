...
<div class="control-group">
	<div class="controls">
		...
		&nbsp;
		<button class="button btn" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user', FALSE); ?>'" ><?php echo vmText::_('COM_VIRTUEMART_CANCEL'); ?></button>
	</div>
</div>