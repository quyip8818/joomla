...
<?php if($this->userDetails->virtuemart_user_id==0) {
	echo '<h3 class="m_title upperCase">'.vmText::_('COM_VIRTUEMART_YOUR_ACCOUNT_REG').'</h3><hr>';
}?>
<form method="post" id="adminForm" name="userForm" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user',$this->useXHTML,$this->useSSL) ?>" class="form-validate form-horizontal">
...
?>
	...
	<div class="control-group">
		<div class="mt2x">
			<button class="button btn btn-primary" type="submit" onclick="javascript:return myValidator(userForm, true);" ><?php echo $this->button_lbl ?></button>
			&nbsp;
