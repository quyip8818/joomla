...
<div class="cart-view">
	<div class="vm-cart-header-container">
		<div class="vm-cart-header">
			...
			<h1 class="page-title"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TITLE'); ?></h1>
	...
	?><form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
		...
		if(VmConfig::get('multixcart')=='byselection'){
			...
			?><input type="submit" name="updatecart" title="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" value="<?php echo vmText::_('COM_VIRTUEMART_SAVE'); ?>" class="btn"  style="margin-left: 10px;"/><?php
		}
