...
<div class="vmCartModule vmCartModule<?php echo $module->id; ?> <?php echo $params->get('moduleclass_sfx'); ?>" id=" vmCartModule<?php echo $module->id; ?>">
<?php
if ($show_product_list) {
	?>
	<div class="vmhiddencontainer" style=" display: none; ">
