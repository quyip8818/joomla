...
$modID = $module->id;
$modPath = JURI::base(true).'/modules/mod_hg_wowslider/';
...
<div id="wowslider-container" class="<?php echo ($shadows ? 'drop-shadow '.$shadows :'' );?>">
	<div class="ws_images">
		<ul>
<?php
if($slide) {
...
?>
	<script type="text/javascript" src="<?php echo $modPath; ?>assets/js/wowslider.js"></script>
	<script type="text/javascript" src="<?php echo $modPath; ?>assets/js/<?php echo $effect; ?>.js"></script>
